...
**Truth (Red dot?):**  YES (has disease)   ! NO (no disease)

**Model Prediction (Probability):** 0.07

**Deadly Variant? (Star):** ⃝ YES   ! NO
...
**Did your classification change from Round 1?** ⃝ YES  ! NO
...
**Sensitivity:** 95% (Did this go up ↑ or down ↓ from Round 1?)
19 / 20 = .95 - WENT UP

**Specificity:** 41% (Did this go up ↑ or down ↓ from Round 1?)
7 / 17 = .411 - WENT DOWN
