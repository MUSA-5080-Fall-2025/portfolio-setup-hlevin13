...
recidivism_data <- read_csv(here("week-10/lecture/data/NIJ_s_Recidivism_Challenge_Full_Dataset_20240407.csv"))
...
# Traditional policing practices, like stop and frisk, have disproportionally targeted Black Americans.
# Additionally, White Americans, who tend to live in areas of higher economic means, are more likely to be offered programming or opportunities that rehabiliate.
