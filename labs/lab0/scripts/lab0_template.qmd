...
- Rows: [50,000]
- Columns: [7]  
- Variable types: [integer, numeric, character, factor]
- Problematic names: [Fuel type?]
...
**Your answer:** [The tibble prints a much more limited view of the data: 6x7 vs 50,000x7]
...
car_summary_1 <- car_data %>%  
  select(Manufacturer, Price, `Fuel type`) 

# Challenge: Select all columns EXCEPT Engine Size
car_summary_2 <- car_data %>%  
  select(Model, Mileage, Manufacturer, Price, `Fuel type`) 
...
**Your answer:** [`Year of manufacture` contains a space, which makes it a broken sequence]
